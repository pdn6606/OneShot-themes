...
- You may need to adjusts some of the settings for panel and desktop as well, examples like fonts, fonts size and icons size. The fonts used in the preview is Terminus (TTF) Bold.
## Preview:
